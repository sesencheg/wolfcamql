...
equ     trap_PeekSnapshot                               -122
equ     trap_CalcSpline                                 -123
equ     trap_SetPathLines                               -124
equ trap_GetGameStartTime -125
equ trap_GetGameEndTime -126
equ trap_GetFirstServerTime -127
equ trap_GetLegsAnimStartTime -128
equ trap_GetTorsoAnimStartTime -129
equ trap_R_RegisterShaderLightMap -130
equ trap_autoWriteConfig -131
equ trap_SendConsoleCommandNow -132
equ powf -133
equ trap_R_ClearRemappedShader -134
equ trap_GetItemPickupNumber -135
equ trap_GetItemPickup -136
equ trap_R_GetSingleShader -137
equ trap_Cvar_Exists -138
equ trap_Get_Demo_Timeouts -139
equ trap_GetNumPlayerInfos -140
equ trap_GetExtraPlayerInfo -141
equ trap_GetRealMapName -142
equ trap_R_AddRefEntityPtrToScene -143
equ trap_S_PrintSfxFilename -144
equ trap_Key_GetOverstrikeMode -145
equ trap_Key_SetOverstrikeMode -146
equ trap_Key_SetBinding -147
equ trap_Key_GetBindingBuf -148
equ trap_Key_KeynumToStringBuf -149
equ trap_R_GetGlyphInfo -150
equ trap_GetLastServerTime -151
equ trap_R_GetFontInfo -152
